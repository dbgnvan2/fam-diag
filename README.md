...
*   **Startup Hint**: On launch and after File > New, a small non-blocking card explains that right-click (Control-click) on the canvas is where the add options live. It carries a "Don't show this again" checkbox, and dismisses itself as soon as you open a context menu.
