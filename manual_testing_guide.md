...
5.  **Selection + Context Menus:**
    ...
    *   Drag the Timeline slider (toolbar, left of Zoom) toward newer dates and confirm people, PRLs, and EPLs whose primary start dates are before the selected date disappear. Slide back toward the start to show everything again.
