...
# Family Diagram App — Gemini CLI Instructions
...
1.  **Add to Requirements:** The new requirement should be added to the appropriate section of the consolidated requirements document (`REQUIREMENTS.md`).
